...
public class NetConnection {
    public NetConnection(final String url, final HttpMethod method, final SuccessCallback successCallback, final FallCallback fallCallback, final String ... kvs){
    ...
    public static interface FallCallback{
        void onFall();
    }
}
